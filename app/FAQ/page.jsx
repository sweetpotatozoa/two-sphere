    ...
    return (
        <div className="mb-4">
            <div className="flex items-center cursor-pointer" onClick={onToggle}>
                ...
                <span className="text-zinc-800 text-base font-extrabold font-['Pretendard']">{title}</span>
            </div>
            {isOpen && <div className="text-zinc-800 text-xs font-normal mt-2 font-['Pretendard']">{content}</div>}
        </div>
    );
}
    ...
    const faqData = [
        {
            ...
            content: (
                <>
                    프리미엄 소셜 살롱 서비스 ‘Two Sphere’의 최우선 가치는 참여자분들에게
                    <br />
                    양질의 모임을 제공하는 것입니다. 하나의 Sphere를 2번의 모임으로 운영하면서
                    <br />
                    참여자 간 더욱 활발한 인터렉션이 가능하도록 하고 있습니다.
                </>
            ),
        },
        {
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <br />
                    Sphere 참여 확정 이후 : <span className="font-bold">프로필 사진/이름</span>
                    /나이대/성별/신분/프로필 질문 답변
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    1회차 모임이 진행된 이후 참여자들에게 개별적으로 모임에 대한 피드백을 묻고
                    <br />
                    2회차 모임을 취소할 수 있는 기간이 주어집니다.
                    <br />
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <br />
                    참여 신청 시 희망여부를 조사하며, 희망자가 2명 이상일 경우 2명 중 임의로 결정되며
                    <br />
                    희망자가 없을 경우에도 참여자 중 임의로 결정됩니다.
                </>
            ),
        },
    ];
